interface TeammatePaidEmailParams {
...
export function buildTeammatePaidEmail(p: TeammatePaidEmailParams): string {
  const remainingLine = p.slotsRemaining === 1
    ? '1 player still needs to pay.'
    : `${p.slotsRemaining} players still need to pay.`
...
<head>
  ...
  <title>Teammate registered — Fendo Golf</title>
  <style>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td align="right" style="vertical-align:middle;">
                    <span style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;font-weight:400;letter-spacing:0.18em;text-transform:uppercase;color:#6E8880;">TEAM / UPDATE</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="inner-td" style="background-color:#F1E2C5;padding:40px 36px;border:1px solid #C8B596;border-top:none;border-bottom:none;">
              ...
              <p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;font-weight:400;letter-spacing:0.18em;text-transform:uppercase;color:#BD5846;margin:0 0 20px 0;">TEAM / SLOT FILLED</p>

              <h1 class="heading" style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:30px;font-weight:600;letter-spacing:-0.03em;line-height:1.1;color:#0C1C23;margin:0 0 16px 0;">${p.teammateFirstName} is in, ${p.captainFirstName}!</h1>
              ...
              <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:16px;font-weight:400;line-height:1.65;color:#4D6B59;margin:0 0 28px 0;">
                <strong style="color:#0C1C23;">${p.teammateFirstName} ${p.teammateLastName}</strong> just paid and secured their spot on <strong style="color:#0C1C23;">${p.teamName}</strong> for <strong style="color:#0C1C23;">${p.eventTitle}</strong>. ${remainingLine}
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F8EDD9;border:1px solid #C8B596;border-radius:12px;margin:0 0 28px 0;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;letter-spacing:0.18em;text-transform:uppercase;color:#6E8880;margin:0 0 12px 0;">TEAM STATUS</p>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-top:1px solid #C8B596;padding-top:8px;margin-top:4px;">
                      <tr>
                        <td><p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:10px;color:#6E8880;margin:0;">Awaiting</p></td>
                        <td align="right"><p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:12px;font-weight:600;color:${p.slotsRemaining > 0 ? '#BD5846' : '#4D6B59'};margin:0;">${p.slotsRemaining} player${p.slotsRemaining === 1 ? '' : 's'}</p></td>
                      </tr>
                    </table>
                  </td>
                </tr>
