...
export function buildEventCancellationEmail(p: EventCancellationEmailParams): string {
  ...
  const refundBlock = p.refundInfo
    ? `
              <!-- Refund info box -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F8EDD9;border:1px solid #C8B596;border-radius:12px;margin:0 0 28px 0;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;letter-spacing:0.18em;text-transform:uppercase;color:#BD5846;margin:0 0 10px 0;">REFUND DETAILS</p>
                    <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:15px;font-weight:600;color:#0C1C23;margin:0 0 6px 0;">
                      $${(p.refundInfo.amountRefunded / 100).toFixed(2)} refund issued
                    </p>
                    <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:14px;font-weight:400;line-height:1.6;color:#4D6B59;margin:0;">
                      A full refund has been processed to your original payment method. Funds typically appear within <strong style="color:#0C1C23;">5&ndash;10 business days</strong> depending on your bank.
                    </p>
                  </td>
                </tr>
              </table>`
  ...
  const refundNote = p.refundInfo
    ? `Your payment of <strong style="color:#0C1C23;">$${(p.refundInfo.amountRefunded / 100).toFixed(2)}</strong> has been fully refunded. `
    : ''
...
<head>
  ...
  <title>Event Cancelled: ${p.eventTitle} — Fendo Golf</title>
  <style>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td align="right" style="vertical-align:middle;">
                    <span style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;font-weight:400;letter-spacing:0.18em;text-transform:uppercase;color:#6E8880;">EVENT UPDATE</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="inner-td" style="background-color:#F1E2C5;padding:40px 36px;border:1px solid #C8B596;border-top:none;border-bottom:none;">
              ...
              <p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;font-weight:400;letter-spacing:0.18em;text-transform:uppercase;color:#BD5846;margin:0 0 20px 0;">EVENT CANCELLATION NOTICE</p>

              <h1 class="heading" style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:30px;font-weight:600;letter-spacing:-0.03em;line-height:1.1;color:#0C1C23;margin:0 0 16px 0;">A tournament you registered for has been cancelled</h1>
              ...
              <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:16px;font-weight:400;line-height:1.65;color:#4D6B59;margin:0 0 28px 0;">
                Hi <strong style="color:#0C1C23;">${p.recipientName}</strong> &mdash; we&rsquo;re sorry to let you know that <strong style="color:#0C1C23;">${p.eventTitle}</strong> has been cancelled.
                ${refundNote}Visit your account for full details.
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F8EDD9;border:1px solid #C8B596;border-radius:12px;margin:0 0 28px 0;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;letter-spacing:0.18em;text-transform:uppercase;color:#6E8880;margin:0 0 12px 0;">CANCELLED EVENT</p>
                    ...
                    ${p.eventDate ? `<p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:11px;line-height:1.6;color:#4D6B59;margin:0;">${p.eventDate}</p>` : ''}
                    ${locationLine}
                    ...
                    <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:13px;font-weight:400;line-height:1.5;color:#6E8880;margin:12px 0 0;">
                      Status: <strong style="color:#BD5846;">Cancelled</strong>
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:14px;font-weight:400;line-height:1.6;color:#4D6B59;margin:0 0 20px 0;">
                View the status of all your registrations and any refund details in your Fendo Golf account.
              </p>
              ...
              <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:13px;font-weight:400;line-height:1.6;color:#4D6B59;margin:0;">
                Questions? Reply to this email or visit <a href="${p.siteUrl}/account" style="color:#BD5846;text-decoration:none;">${p.siteUrl.replace(/^https?:\/\//, '')}/account</a> to see your registration history.
              </p>
          ...
          <tr>
            <td class="footer-td" style="background-color:#F8EDD9;padding:22px 36px;border:1px solid #C8B596;border-top:none;border-radius:0 0 16px 16px;">
              <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:12px;line-height:1.6;color:#6E8880;margin:0 0 6px 0;">
                You received this because you registered for an event on Fendo Golf. This notification was sent to inform you of a cancellation.
              </p>
              <p style="font-family:'IBM Plex Mono','Courier New',monospace;font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:#9D8762;margin:0;">
                &copy; Fendo Golf &nbsp;&middot;&nbsp; <a href="${p.siteUrl}" style="color:#9D8762;text-decoration:none;">fendogolf.com</a>
              </p>
            </td>
          </tr>
